...
class AtariHeadDataset():
    ...
    def __init__(self, env_name, data_path):
        '''
            ...
            data_path is the root of the dataset
            (the folder which contains the metadata.csv file and the game folders, 
            each of which contains the trajectory folders 
            and text files documenting gaze data).
        '''

        self.trajs_path = data_path
        self.env_name = env_name

        # check that we have the trajs where expected
